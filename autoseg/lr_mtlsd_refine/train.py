...
def pipeline(iterations, warmup=5000, save_every=1000):
    ...
    def get_training_pipeline():
        ...
        # training_pipeline += gp.RandomLocation(mask=labels_mask, min_masked=0.2)
    ...
    if (
        ...
        get_segmentation(predict_affs=True)
        model.train()
    elif warmup > 0:
    ...
    for ratio in [0.3, 0.4, 0.5, 0.6, 0.6, 0.8]:
...
if __name__ == "__main__":
    pipeline(iterations=20000, warmup=20000, save_every=10000)
