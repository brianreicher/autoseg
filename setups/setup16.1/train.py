...
def pipeline(iterations, warmup=5000, save_every=1000):
    ...
    optimizer = torch.optim.Adam(model.parameters(), lr=0.1e-3, betas=(0.95, 0.999))
...
if __name__ == "__main__":
    # pipeline(5000, 10000, 5000)
    # pipeline(5000, None, 5000)
    pipeline(5000, 0, 5000)
